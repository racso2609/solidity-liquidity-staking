...
contract StakingManager is Ownable {
 ...
 /*_rewardsDistribution=*/ address(this), 
	...
	function update(uint256 _stakeId, uint256 _rewardAmount, uint256 _rewardsDuration)
		public
		onlyOwner
	{
  ...
  function stake(uint256 _amount,uint256 _stakeId) external{
    StakingRewards(stakingRewardsTokenInfo[_stakeId].stakingRewards).stake(_amount);
  }
  function stakeWithPermit(
    ...
    StakingRewards(stakingRewardsTokenInfo[_stakeId].stakingRewards).stakeWithPermit(_amount,DEADLINE,_v,_r,_s);
  }
